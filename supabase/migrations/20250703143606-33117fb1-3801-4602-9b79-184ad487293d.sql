-- Fix the data population with correct enum values
...
SELECT 
    ...
    true,
    CASE 
        WHEN random() < 0.3 THEN 'high-risk'::flag_level
        WHEN random() < 0.6 THEN 'complex'::flag_level
        ELSE 'standard'::flag_level
    END,
...
-- Other/Behavioral Support adjustments
INSERT INTO public.adjustment_details (
    reasonable_adjustments_id, 
    category, 
    description, 
