          ...
          <div className="pr-4 space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea placeholder="Please provide a detailed reason for rejection..." value={rejectNotes} onChange={e => setRejectNotes(e.target.value)} rows={6} className="resize-none" />
                {!rejectNotes && <p className="text-sm text-muted-foreground">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6">
              <Button onClick={handleReject} disabled={isSubmitting || !rejectNotes.trim()} variant="destructive" className="flex-1">
