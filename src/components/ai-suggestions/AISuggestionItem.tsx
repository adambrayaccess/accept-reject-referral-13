        ...
        <CollapsibleContent className="mt-3 pt-3 border-t">
          <div className="space-y-2">
            ...
            {suggestion.type === 'triage-status' && (
              <div>
                <span className="text-xs font-medium text-muted-foreground">Suggested Status:</span>
                <p className="text-sm">{(suggestion as any).suggestedStatus}</p>
              </div>
            )}
            ...
            {suggestion.type === 'appointment' && (
              <div>
                ...
                <p className="text-sm">{(suggestion as any).urgency} - {(suggestion as any).suggestedTimeframe}</p>
              </div>
            )}
