  ...
  "inline-flex items-center justify-center gap-1",
  {
    variants: {
      variant: {
        ...
        compact: "bg-muted/20 rounded-md p-0.5 text-muted-foreground",
        pills: "gap-1 text-muted-foreground",
  ...
  "inline-flex items-center justify-center whitespace-nowrap transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 focus-visible:ring-[3px] focus-visible:border-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        compact: "rounded font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm hover:bg-muted/60 data-[state=active]:hover:bg-background",
        pills: "rounded-full font-medium border ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:border-primary hover:bg-muted/60 data-[state=active]:hover:bg-primary/90",
        grid: "flex rounded-md font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm hover:bg-muted/60 data-[state=active]:hover:bg-primary/90 min-h-[2.5rem] text-center",
...
function TabsList({
  ...
  React.useEffect(() => {
    ...
    const checkOverflow = () => {
      ...
      setCanScrollRight(
        container.scrollLeft < listWidth - containerWidth - 1
      );
    };
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn(
        "flex-1 outline-none overflow-auto",
        "motion-safe:transition-opacity",
        className
      )}
      {...props}
